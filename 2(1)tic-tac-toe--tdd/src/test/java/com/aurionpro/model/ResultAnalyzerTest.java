...
//	}
	...
	@Test
	void testDiagonalWinCheck_diagonalWin1() throws CellAlreadyMarkedException {
		cells[2].setMark(MarkType.X);
		cells[4].setMark(MarkType.X);
		cells[6].setMark(MarkType.X);
		assertEquals(ResultType.WIN, result1.analyseResult());
	...
	void testAnalyzeResult_CheckTestProgress() throws CellAlreadyMarkedException {
		...
		cells[4].setMark(MarkType.X);
		cells[5].setMark(MarkType.X);
		assertEquals(ResultType.PROGRESS, result1.analyseResult());
	}
	...
	void testAnalyzeResult_CheckTestDraw() throws CellAlreadyMarkedException {
		...
		cells[3].setMark(MarkType.O);
		cells[4].setMark(MarkType.O);
		cells[5].setMark(MarkType.X);
		cells[6].setMark(MarkType.X);
		cells[7].setMark(MarkType.O);
		cells[8].setMark(MarkType.X);
		assertEquals(ResultType.DRAW, result1.analyseResult());
	}
